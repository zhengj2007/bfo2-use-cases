...
/** 
 * 	Assign IDs to LIMS ontology
 *
 *  @author Jie Zheng
 */
public class AssignLIMSids {
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		// locations of ontology files
 		String path = "C:/Documents and Settings/Jie/My Documents/ontology/LIMS/Query examples/";
 		String ontFile = path + "patient/LIMS_patient.owl";
		String newOntFilename = path + "patient/LIMS_patient_new.owl";		

 		// start number of ID
 		int offset = 1;	
 		String base = "http://purl.obolibrary.org/obo/";
 		// ID space
 		String idSpace = "OBIlims";
