...
/** 
 * Add 'Editor Preferred label' to Classes by copy rdfs:label if the annotation property has not be set.
 * 
 * @author Jie Zheng
 * @version 
 */
...
public class AddEditorPreferredTerms {
	...
	public static void main(String[] args) {
        ...
        for (OWLClass cls : ont.getClassesInSignature()) {
            ...
            if (!hasPreferredTerm) {   
            	OWLLiteral labelOWLLiteral = OBOentity.getLabelOWLLiteral(cls, ont, df);
