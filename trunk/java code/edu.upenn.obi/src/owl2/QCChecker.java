...
/** 
 * 	Ontology quality checking during release process
 * 		Not working, still work on it 
 *
 *  @author Jie Zheng
 */
public class QCChecker {
	...
	public void checkMultiplePropVals(IRI annotPropIRI) {
		...
		for (OWLClass cls : ontology.getClassesInSignature()) {
			ArrayList<String> labels = OBOentity.getOWLLiteralAnnotProps(df, ontology, cls, annotPropIRI);
			if (labels.size() > 1) {
