...
/** 
 * 	Extract IEDB specific annotation information from OBI and stored in separate OWL file as independent annotation layers
 *  	- inSubset layer, IEDB preferred label layer
 *  
 *  @author Jie Zheng
 */
            ...
            for (OWLAnnotation annotation : cls.getAnnotations(ont, annotProp)) {
            	...
            	if (annotation.getValue() instanceof OWLLiteral) {
        		    ...
        		    if (val.getLiteral().length() > 0) {
        		    	...
        		    	System.out.println(cls.getIRI().toString() + " " + OBOentity.getLabel(cls,ont,df));
        		    }
            	}
            } 
        } 
